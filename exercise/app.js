...
//event listener fun
function Eventlistener(ele,event,callback){
  document.querySelector(ele).addEventListener(event,callback)
}

//XMlHTTPRequest func
function afterlondingEvent(callback){
...
// const callbackListener = function(e,url,callback){
//   e.preventDefault();
...
//   }
//   afterlondingEvent(callback)
// }


Eventlistener('#form-unanswered','submit',function (e) {
  e.preventDefault();
...
Eventlistener('#form-answerers','submit',function (e) {
  e.preventDefault();
